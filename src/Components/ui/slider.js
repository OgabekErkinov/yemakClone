...
export var Slider = React.forwardRef(function Slider(props, ref) {
    ...
    return (_jsxs(ChakraSlider.Root, __assign({ ref: ref, thumbAlignment: "center" }, rest, { children: [label && !showValue && (_jsx(ChakraSlider.Label, { children: label })), label && showValue && (_jsxs(HStack, { justify: "space-between", children: [_jsx(ChakraSlider.Label, { children: label }), _jsx(ChakraSlider.ValueText, {})] })), _jsxs(ChakraSlider.Control, { "data-has-mark-label": hasMarkLabel || undefined, children: [_jsx(ChakraSlider.Track, { children: _jsx(ChakraSlider.Range, {}) }), _jsx(SliderThumbs, { value: value }), _jsx(SliderMarks, { marks: marks })] })] })));
});
function SliderThumbs(props) {
    var value = props.value;
    return (_jsx(For, { each: value, children: function (_, index) { return (_jsx(ChakraSlider.Thumb, { index: index, children: _jsx(ChakraSlider.HiddenInput, {}) }, index)); } }));
}
var SliderMarks = React.forwardRef(function SliderMarks(props, ref) {
    var marks = props.marks;
    if (!(marks === null || marks === void 0 ? void 0 : marks.length))
        return null;
    return (_jsx(ChakraSlider.MarkerGroup, { ref: ref, children: marks.map(function (mark, index) {
